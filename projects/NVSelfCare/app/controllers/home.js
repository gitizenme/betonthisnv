...
function onAndroidBack() {
	...
	alertDialog.addEventListener('click', function(e) {
		...
		Alloy.Globals.ExitApplicationByUser = true;
...
function open() {
	...
	if (OS_ANDROID) {
		$.home.activity.addEventListener('stop', stopActivityAndroid);
		$.home.activity.addEventListener('restart', restartActivityAndroid);
		$.home.activity.addEventListener('pause', pauseActivityAndroid);
		$.home.activity.addEventListener('resume', resumeActivityAndroid);
	}
